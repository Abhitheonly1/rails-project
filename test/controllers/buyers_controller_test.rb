...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { buyer_id: @buyer.buyer_id, email: @buyer.email, mobile: @buyer.mobile, name: @buyer.name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { buyer_id: @buyer.buyer_id, email: @buyer.email, mobile: @buyer.mobile, name: @buyer.name } }
